...
To begin with this lab, you can copy the text-func folder in this repo, or it will be created for you by running the first cli command below. The other commands 
```
...
## Putting the function behind the gateway

## Calling the function's new endpoint
